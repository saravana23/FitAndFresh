...
namespace FitAndFresh.Data.Migrations
{
    ...
    [Migration("20210220232147_AddOrderInformationAndOrderProcessingInformation")]
    partial class AddOrderInformationAndOrderProcessingInformation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitAndFresh.Models.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FitAndFresh.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FitAndFresh.Models.AddUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("AddUser");
                });
            ...
            modelBuilder.Entity("FitAndFresh.Models.SubCategory", b =>
                {
                    b.HasOne("FitAndFresh.Models.Category", "Category")
                        .WithMany()
